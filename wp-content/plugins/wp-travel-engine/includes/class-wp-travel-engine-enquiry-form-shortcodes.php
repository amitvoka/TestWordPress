				...
				switch ($key) {
					case 'contact': ?>
			            <div class="row-repeater contact">
							<label for="enquiry_contact"><?php echo isset($value['label']) ? $value['label'] : __('Contact No.:','wp-travel-engine');?><span class="required">*</span></label>
							<input id="enquiry_contact" class="input" name="enquiry_contact" type="text" value="" size="30" placeholder="<?php echo isset($value['placeholder']) ? $value['placeholder'].'*' : __('Enter Your Contact Number *', 'wp-travel-engine' ); ?>" <?php if($value['required'] == '1'){ echo 'required'; } ?>/>
			            </div>
					<?php
					break;
					...
					case 'adults': ?>
			            <div class="row-repeater adult">
							<label for="enquiry_adult"><?php echo isset($value['label']) ? $value['label'] : __('Adults:','wp-travel-engine');?><span class="required">*</span></label>
							<input id="enquiry_adult" class="input" name="enquiry_adult" type="number" value="" size="30" placeholder="<?php echo isset($value['placeholder']) ? $value['placeholder'].'*' : __('Enter Number of Adults *', 'wp-travel-engine' ); ?>" <?php if($value['required'] == '1'){ echo 'required'; } ?> />
			            </div>
					<?php
					break;
					...
					case 'children': ?>
			            <div class="row-repeater children">
							<label for="enquiry_children"><?php echo isset($value['label']) ? $value['label'] : __('Children:','wp-travel-engine');?></label>
							<input id="enquiry_children" class="input" name="enquiry_children" type="number" value="" size="30" placeholder="<?php echo isset($value['placeholder']) ? $value['placeholder'] : __('Enter Number of Children', 'wp-travel-engine' ); ?>" <?php if($value['required'] == '1'){ echo 'required'; } ?> />
						</div>
					<?php
					break;
					...
					case 'message': ?>
			            <div class="row-repeater msg-holder">
			            	<div class="row-form">
			            		<label for="enquiry_message"><?php echo isset($value['label']) ? $value['label'] : __('Your message:','wp-travel-engine');?><span class="required">*</span></label>
								<textarea id="enquiry_message" class="input" name="enquiry_message" rows="7" cols="30" placeholder="<?php echo isset($value['placeholder']) ? $value['placeholder'].'*' : __('Your Message *', 'wp-travel-engine' ); ?>" <?php if($value['required'] == '1'){ echo 'required'; } ?> ></textarea>
			            	</div>
			            </div>
					<?php
					break;
					...
					case 'country': ?>
						<div class="row-repeater country-holder">
							<label for="enquiry_country"><?php echo isset($value['label']) ? $value['label'] : __('Country:','wp-travel-engine');?><span class="required">*</span></label>
			                <select  id="enquiry_country" name="enquiry_country" data-placeholder="<?php echo isset($value['placeholder']) ? $value['placeholder'].'*' :__( 'Choose a country&hellip;', 'wp-travel-engine' ); ?>" class="wc-enhanced-select" <?php if($value['required'] == '1'){ echo 'required'; } ?>>
			                        <option value=" "><?php echo isset($value['placeholder']) ? $value['placeholder'].'*' : __( 'Choose country&hellip; *', 'wp-travel-engine' ); ?></option>
			                        <?php
			                        $obj = new Wp_Travel_Engine_Functions();
